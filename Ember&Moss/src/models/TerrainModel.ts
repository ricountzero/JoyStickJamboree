...
export function makeGroundTexture(scene: Phaser.Scene): void {
  const g = scene.make.graphics({ x: 0, y: 0, add: false });
  g.fillStyle(0x7ec850); g.fillRect(0, 0, 32, 8);   // grass top
  g.fillStyle(0xa0522d); g.fillRect(0, 8, 32, 32);   // dirt body
...
export function makePlatformTexture(scene: Phaser.Scene): void {
  const g = scene.make.graphics({ x: 0, y: 0, add: false });
  g.fillStyle(0x7ec850); g.fillRect(0, 0, 32, 8);    // grass top
  g.fillStyle(0xa0522d); g.fillRect(0, 8, 32, 24);   // dirt body
