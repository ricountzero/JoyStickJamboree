...
export const SWAMP_ZONES: [number, number][] = [
  [640,  704],
  [1280, 1344],
  [1920, 1984],
  [2560, 2624],
...
export const FIRE_POSITIONS: number[] = [
...
export const FERN_DECO_POSITIONS: number[] = [
...
export const PLATFORM_LAYOUT: [number, number, number][] = [
...
export const COLLECTIBLE_POSITIONS: [number, number][] = [
